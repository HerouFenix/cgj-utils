...
Tetromino_RS::Tetromino_RS(float colour[4], Vector4 center) : Tetromino(colour, center) {
...
Tetromino_RS::Tetromino_RS(Vector4 center) : Tetromino(center) {
	// Define base transformations to create the figure from the base square
	Matrix4 identity = Matrix4::identity();
	transforms[0] = identity;
